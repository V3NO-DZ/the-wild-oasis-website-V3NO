...
function ReservationReminder(): React.JSX.Element | null {
  // CHANGE
  ...
  return (
    <div className='fixed bottom-6 left-1/2 -translate-x-1/2 py-5 px-8 rounded-full bg-accent-500 text-primary-800 text  font-semibold shadow-xl shadow-slate-900 flex gap-8 items-center'>
      ...
      <button className='rounded-full p-1 hover:bg-accent-600 transition-all' aria-label='Close reminder' title='Close reminder'>
